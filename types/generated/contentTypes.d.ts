...
export interface ApiPopulatiryPopulatiry extends Schema.CollectionType {
  collectionName: 'populatiries';
  info: {
    singularName: 'populatiry';
    pluralName: 'populatiries';
    displayName: 'Populatiry';
    description: '';
  };
  options: {
    draftAndPublish: true;
